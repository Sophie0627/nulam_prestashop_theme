(function ($) {
    ...
    var jsonDataFromAllGroups = [
        ...
        ["", "", "", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", "", "", ""],
        ["Nieuw !!!!", "Nieuw !!!!", "Nieuw !!!!", "Nylabone Puppy Chicken", "Nylabone Puppy 2 in 1",
            "Nylabone Breakfast Bone",
    ...
    $(document).ready(function () {
        ...
        function isAllFieldsFilled(index) {
            if (jsonDataFromAllGroups[index][0] != '' && jsonDataFromAllGroups[index][1] != '' && jsonDataFromAllGroups[
                index][2] != '' && jsonDataFromAllGroups[index][3] != '' && jsonDataFromAllGroups[index][4] != '' &&
                jsonDataFromAllGroups[index][5] != '' && jsonDataFromAllGroups[index][6] != '' && jsonDataFromAllGroups[
                index][7] != '' && jsonDataFromAllGroups[index][8] != '' && jsonDataFromAllGroups[index][9] != '' &&
