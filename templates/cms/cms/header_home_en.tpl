...
<div id="gkHeaderNav" class="gk-clearfix gk-fixed contains-cart" style="top: 0px;">
    <div>
        <a href="https://budgetdesinfectie.nl/en/" id="gkLogo">
            ...
            <nav class="gkMainMenu gkMenu" data-duration="150" data-opacity="1" data-height="1" data-width="1">
                <ul class="gkmenu level0">
                    <li class="first {if $page.page_name=='index'}active{/if}">
                        <a href="https://budgetdesinfectie.nl/en/" class=" first active" id="menu1167">Home</a>
                    </li>
                    <li class="haschild {if $page.page_name=='cms' && $cms.id_cms_category==2}active{/if}">
                        <span class=" haschild" id="menu1387">About Us</span>
                            ...
                            <div class="childcontent-inner">
                                <div class="gkcol gkcol1  first">
                                    <ul class="gkmenu level1">
                                        ...
                                        <li>
                                            <a href="/en/about-us/vital-ingredients.html" id="menu1389">Vital
                                                ingredients</a>
                                        </li>
                                        <li>
                                            <a href="/en/about-us/benefits-of-nulam.html" id="menu1390">Benefits of
                                                nulam</a>
                                        </li>
                                        <li>
                                        ...
                                        <li class="last">
                                            <a href="/en/about-us/customer-reviews.html" class=" last"
                                                id="menu1430">Customer reviews</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <li class="haschild {if $page.page_name=='category' || $page.page_name=='product'}active{/if}">
                        <span class=" haschild" id="menu1092">Store</span>
                    ...
                    <li class="haschild {if $page.page_name=='cms' && $cms.id_cms_category==3}active{/if}">
                        <span class=" haschild" id="menu1218">Feeding Advice</span>
                        <div class="childcontent has-cols-1">
                            <div class="childcontent-inner">
                                <div class="gkcol gkcol1  first">
                                    <ul class="gkmenu level1">
                                        <li class="first"><a href="/en/feeding-advice/nutrition-calculator.html"
                                                class=" first" id="menu1274">Nutrition Calculator</a></li>
                                        <li class="last"><a href="/en/feeding-advice/how-to-switch.html" class=" last"
                                                id="menu1273">How to Switch</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="gk-login-popup"><a href="/en/login-page.html" class=" gk-login-popup" id="menu1043">Login
                            /
                            Register</a></li>
                    <li class="last {if $page.page_name=='contact'}active{/if}"><a href="/en/contact" class=" last"
...
<div id="gkHeaderMod" class="gk-clearfix">
    ...
    <div id="ca_banner" style="top:0px;">
        <p style="
                    ">Nulam® uses cookies which enables us to help you in a better and more personal way. These cookies
            allow us and external parties to follow your internet behaviour. Furthermore, this enables us to show you
            personalised advertisements, a better functioning website and creates the opportunity for you to share
            information on social media. By continuing on our website, you will agree to these terms.<span
                class="infoplus" style=""><a href="/en/cookie-statement.html">Learn more</a></span>
        </p>
...
<div class="modulediv">
    <div class="innermdule">
        <div class="region region-banner-header-layer">
            <ul class="item-list holder">
                <li>
                    <a href="/en/store/snacks/trainers.html">
                        ...
                        <div class="img-wrap">
                            <img src="/images/stories/virtuemart/product/vlees-front-2.png"
                                alt="Training Treats Nulam Trainers">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="/en/store/nulam-fresh/puppy-junior/pure-puppy-complete-detail.html">
                        ...
                        <div class="img-wrap">
                            <img src="/images/stories/virtuemart/product/fresh-front.png"
                                alt="Pure Fresh Meat Nulam Fresh">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="/en/store/nulam-chunks/puppy-junior/perfect-bulldog-junior-detail.html">
                        ...
                        <div class="img-wrap">
                            <img src="/images/stories/virtuemart/product/bulldog-junior-front.png"
                                alt="Puppy Chunks Perfect Bulldog Junior">
                        </div>
                    </a>
                </li>
            </ul>
            ...
            <img src="/" alt=" " style="display:none !important">
            <img src="/images/stories/virtuemart/product/free-front.png" alt="Tasty Chunks Gluten-free Formula"
                style="display:none !important">
            <img src="/" alt=" " style="display:none !important">
            <img src="/" alt=" " style="display:none !important">
            <img src="/" alt=" " style="display:none !important">
            <img src="/images/stories/virtuemart/product/nylabone-front.png" alt="New !!! Nylabone Puppy Chicken"
                style="display:none !important">
            <img src="/images/stories/virtuemart/product/nylabone-puppy-2in1-front.png"
                alt="New !!! Nylabone Puppy 2 in 1" style="display:none !important">
            <img src="/images/stories/virtuemart/product/nylabone-breakfastbone-front.png"
                alt="New !!! Nylabone Breakfast Bone" style="display:none !important">
            <img src="/" alt=" " style="display:none !important">
            <img src="/" alt=" " style="display:none !important">
            <img src="/" alt=" " style="display:none !important">
        </div>
        <script src="https://budgetdesinfectie.nl/themes/PRS020/assets/js/nulam/header_home_en.js"
            type="text/javascript"></script>

        <div class="maindiv">
            <span class="newdivcircle"><span>Prepared</span><strong>FROM THE BEST</strong>Ingredients</span>
        </div>
        <p>&nbsp;</p>
    </div>
</div>