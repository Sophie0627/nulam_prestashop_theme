    ...
    <div class="product-prices">
        ...
        {block name='product_price'}
            <div class="product-price" id="productPrice2">
                ...
                <div class="PricesalesPrice vm-display vm-price-value current-price {if $product.has_discount}has-discount{/if}"
                    itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                    <span class="vm-price-desc">Verkoopprijs:</span>
                    <span itemprop="price" content="{$product.price_amount}" class="PricesalesPrice">{$product.price}</span>
                    {if $product.has_discount}
