                ...
                <div class="product-information">
                    ...
                    <div class="product-actions">
                        {block name='product_buy'}
                            <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh side-block-wrap">
                                ...
                                <div class="img-wrap">
                                    <div class="cycle-slideshow" data-cycle-fx="scrollHorz" data-cycle-pause-on-hover="true"
                                        data-cycle-speed="500" data-cycle-loader="wait"
                ...
                {block name='product_tabs'}
                    <div class="tabs">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            {/foreach}
                            {hook h='ProductTab' mod='ishiproductcomments'}
                        </ul>
                        ...
                        <div class="tab-content" id="tab-content">
                            ...
                            {hook h='productTabContent' mod='ishiproductcomments'}
                        </div>
                    {/block}
                </div>
            </div>
                ...
                {if $accessories}
                    <section class="product-accessories-block clearfix col-sm-12">
                        <div class="products_block_inner">
                            <p class="home-title">{l s='You might also like' d='Shop.Theme.Catalog'}</p>
