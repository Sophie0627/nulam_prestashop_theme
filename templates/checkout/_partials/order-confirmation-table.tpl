    ...
    {block name='order_confirmation_table'}
      {foreach from=$products item=product}
        <div class="order-line row">
          ...
          <div class="col-sm-6 col-xs-12 qty text-xs-right">
            <div class="row">
              <div class="col-xs-5 text-smright text-xs-left">{$product.price}</div>
      ...
      <table>
        {hook h="displayPaymentRuleOrderConfirmation"}
